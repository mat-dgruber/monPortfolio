  ...
  return (
    <div className="flex items-center gap-2.5">
      ...
      <button
        type="button"
        onClick={handlePrint}
        className="font-body inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#EDE7DC] text-[#0A0C0E] text-[10.5px] font-bold uppercase tracking-[0.12em] hover:bg-white transition-colors shadow-sm"
      >
